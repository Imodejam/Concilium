  ...
  return (
    <div className="space-y-6">
      ...
      <header className="space-y-3">
        ...
        <h1 className="font-display text-2xl text-senate-gold">Princeps Senatus has spoken</h1>
            ...
            {contributions.map((c) => (
              <div key={c.senator_id} className="bg-zinc-950 border border-zinc-800 rounded p-3">
                <div className="flex items-center gap-2 flex-wrap text-xs">
                  ...
                  <span className="text-zinc-500 ml-auto">{c.duration_ms} ms</span>
                </div>
      ...
      <details className="bg-zinc-900 border border-zinc-800 rounded p-3 text-xs">
        ...
        <pre className="mt-2 overflow-x-auto text-zinc-300">{JSON.stringify(decision, null, 2)}</pre>
      </details>
    </div>
  );
}
